/* Author: Kim Baraka (kbaraka@andrew.cmu.edu , kimbaraka.com)
...
//*******************Scenario specific*********************************
        ...
        total_time = atol(value);
        //Serial.print("total:");
        //Serial.println(total_time);        
      }
      else if(param == "remaining"){
        if(atol(value) != remaining_time_old) remaining_time_old = remaining_time;
        remaining_time = atol(value);
        //Serial.print("remaining:");
        //Serial.println(remaining_time);        
      }
      
      else if(param == "path_blocked"){
        path_blocked = atol(value);
      }
      
      else if(param == "task_type"){
        task_type = value;
...
//******************Run animations based on command***********************************************************************  
  ...
  if(path_blocked) {
    ...
    triangular(0.25,250,0,0,0,255,30,0);
    
    //siren(0.25,100,0,100,100);
    //siren(0.25,50,0,100,100);
    
    //agressive_blink(0.4, 2000, strip.Color(255,50,0));
    //agressive_blink(0.4, 1500, strip.Color(0,100,100));
    //agressive_blink(0.4, 900, strip.Color(0,100,100));
  ...
  */
    ...
    Serial.println("Waiting...");
    triangular(0.5,2000,0,0,0,0,255,255);      
  }
  else if(task_type == "escort"){
